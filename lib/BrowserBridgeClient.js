...
class BrowserBridgeClient extends EventEmitter
{
	...
	_handleConnect()
	{
		...
		if(this._options.eventSubscriptions)
		{
			for(const subscription of this._options.eventSubscriptions)
			{
	...
	addEventSubscriber(target, eventPath, subscriber)
	{
		...
		if(subscription == null)
		{
			...
			if(this._options.eventSubscriptions)
			{
				for(const cmpSubscription of this._options.eventSubscriptions)
				{
